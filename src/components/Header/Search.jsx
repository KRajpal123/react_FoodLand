...
export default function PrimarySearchAppBar({ cartItem }) {
  ...
  return (
    <Container maxWidth="xl" sx={{background:'#0f3460',color:'white',flexGrow:1,}}>
        <Toolbar>
          <ImageList sx={{width:"50px",border:'1px solid white',display:'block',
        borderRadius:'50px',mr:"auto"}}>
                <ImageListItem>
          ...
          <Box sx={{ display: { xs: 'none', md: 'flex' }}}>
            ...
            {/* Desktop shopping icon  */}

           <Link to= "/cart" sx={{color:'white'}}>
           <IconButton size="large" aria-label="show 4 new mails" color="success">
              <Badge badgeContent={cartItem.length === 0 ? "0" : cartItem.length} color="error">
               <ShoppingCartIcon color='white' sx={{color:'white'}}/>
              </Badge>
            </IconButton>
           </Link>
